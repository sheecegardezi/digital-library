...
public class testingJAWSApi {
    ...
    public static void main(String[] args) throws FileNotFoundException, JWNLException, CloneNotSupportedException {
        ...
        FileInputStream inputStream = new FileInputStream(Constants.FILE_PATH_WordNet_2_1);
        dictionary = Dictionary.getInstance(inputStream);
        new testingJAWSApi(dictionary).go();
            
            //demonstrateMorphologicalAnalysis( "running away");
    }
    ...
    public testingJAWSApi(Dictionary dictionary) throws JWNLException {
